...
<div id="page-container">
           ...
           <div class="">
            ...
            <nav>
                <ul>
                    ...
                    <a href="en/index.php"><img class="eng" src="img/eng.png"></a>
                </ul>
            </nav>
    ...
    <div class="mob-dropdown">
      <ul class="mob-ul">
        <li class="mob-li"><a href="index.php">Inicio</a></li>
        <li class="mob-li"><a href="about.php">Sobre nosotros</a></li>
        <li class="mob-li"><a href="contactform.php">Contacto</a></li>
        <a href="en/index.php"><img class="eng" src="img/eng.png"></a>
      </ul>
    </div>
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        ...
                        <h5 class="h5-slider">MISION CHALCO MEXICO</h5>
                          <h1 class="h1-slider">DESCRIPCION</h1>
                          <p class="p-slider">DESCRIPCION</p>
                         <div class="s-links">
                            <div class="s-link">
              ...
              <div class="carousel-item">
                <img src="img/m2.jpeg" class="d-block w-100" alt="...">

                <div class="carousel-caption">
                        
                    <h5 class="h5-slider">MISION CHALCO MEX</h5>
                      <h1 class="h1-slider">DESCRIPCION</h1>
                      <p class="p-slider">DESCRIPCION</p>
    ...
    <div class="services">
      <h2 class="h2-services" data-aos="fade">DESCRIPCION</h2>
    ...
    <div class="plx-section1">
      <div class="plx-container">
        ...
        <h4 data-aos="fade">DESCRIPCION</h4>
    ...
    <div class="values" data-aos="fade">
      ...
      <div class="values-column">
        ...
        <a class="btn-values" href="about.php">Sobre nosotros</a>
      </div>
    </div>
    ...
    <div class="plx-section2">
      <div class="values-column2" data-aos="fade">
        <h3>DESCRIPCION</h3>
        <p>DESCRIPCION</p>
        <a class="btn-contact" href="contact.php">CONTACTO</a>
      </div>
    </div>
...
<footer id="footer">
  <div class="footer">
    ...
    <p>MISION CHALCO MEX ES UNA COMUNIDAD GRANDE ETC</p>  
    </div>
    ...
    <div class="column-footer contact">
      ...
      <ul class="ul-footer contact">
        <li><b>TELEFONO:</b> 55123456789 </li>
        <li><b>E-MAIL:</b> info@gmail.com</li>
        <li><b>DIRECCION:</b>CUERNAVACA MORELOS</li>
      </ul>
      <br>
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d120767.57238545817!2d-99.38822511391058!3d18.931985616615325!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85cdde499b22afad%3A0xc9b6bcb5b9b790a1!2sCuernavaca%2C%20Mor.!5e0!3m2!1ses-419!2smx!4v1691884369432!5m2!1ses-419!2smx" width="250" height="160" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </div>
