...
<div id="page-container">
    ...
    <!-- <div id="header-upper">
       <div class="header-container">
          <div class="column-header">
            <a href="contact.php"><p class="fa fa-envelope"> info@orionconsulting.rs</p></a>
          </div>
          <div class="column-header2">
             <a href="contact.php"><p class="fa fa-phone"> +381 11 382 87 87</p></a>
             <a href="contact.php"><p class="fa fa-map-marker"> Kneza Miloša 16</p></a>
          </div>
       </div>
    </div> -->
    <header>
           <div class="logo1">
            ...
            <nav>
                <ul>
                    ...
                    <a href="../about.php"><img class="eng" src="img/mex.png"></a>
                </ul>
            </nav>
    ...
    <div class="mob-dropdown">
      <ul class="mob-ul">
        ...
        <li class="mob-li"><a href="about.php">O nama</a></li>
        <li class="mob-li"><a href="services.php">Usluge</a></li>
        <li class="mob-li"><a href="projects.php">Projekti</a></li>
        <li class="mob-li"><a href="contact.php">Kontakt</a></li>
        <a href="../about.php"><img class="eng" src="img/mex.png"></a>
      </ul>
    </div>
    ...
    <div class="values">
      <div id="or2" class="values-column" data-aos="fade">
        ...
        <a class="btn-values values-about" href="services.php">Discover more</a>
      </div>
    ...
    <div class="plx-section2">
      <div class="values-column2" data-aos="fade">
        ...
        <a class="btn-contact" href="contact.php">Contact us</a>
      </div>
    </div>
